...
import com.flashoverride.homeimprovement.handlers.AbstractPacket;
import com.flashoverride.homeimprovement.handlers.DataBlockPacket;
...
public abstract class NetworkTileEntity extends TileEntity
{
	...
	public void broadcastPacketInRange()
	{
		...
		if(worldObj.isRemote)
			HomeImprovement.packetPipeline.sendToServer(this.createDataPacket());
		else
			HomeImprovement.packetPipeline.sendToAllAround(this.createDataPacket(), 
	...
	{
		if(worldObj.isRemote)
			HomeImprovement.packetPipeline.sendToServer(packet);
		else
			HomeImprovement.packetPipeline.sendToAllAround(packet, 
