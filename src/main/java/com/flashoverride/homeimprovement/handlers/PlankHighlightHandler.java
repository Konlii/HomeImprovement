...
//			double blockMaxZ = evt.target.blockZ+1;
			...
			boolean isConstruct = (world.getBlock(evt.target.blockX, evt.target.blockY, evt.target.blockZ) == HomeImprovement.WoodConstruct) || (world.getBlock(evt.target.blockX, evt.target.blockY, evt.target.blockZ) == HomeImprovement.MetalConstruct);
